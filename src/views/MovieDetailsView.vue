    ...
    <div class="flex flex-col lg:ml-420px">
      ...
      <div class="mt-33px mb-20 lg:mr-16 flex flex-col gap-10">
        ...
        <div class="flex lg:flex-row flex-col-reverse lg:gap-4 gap-8 lg:mb-10 mx-8 lg:mx-0">
          <p class="text-white text-2xl font-medium leading-9 my-auto lg:block hidden">
            {{ $t('movies.quotes') }} ({{ $t('movies.total') }} {{ movie.quotes_count }})
          </p>
          <div class="lg:hidden flex flex-col">
            <p class="text-white text-2xl font-medium leading-9 my-auto">
              {{ $t('movies.quotes') }}
            </p>
            <p class="text-white my-auto">({{ $t('movies.total') }} {{ movie.quotes_count }})</p>
          </div>
