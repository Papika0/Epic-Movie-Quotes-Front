            ...
            <div class=" px-4 py-2 bg-neutral-900 rounded border border-gray-500 relative"
                ...
                <div class="inline-flex gap-2 w-full">
                    ...
                    <textarea :name="name" :id="name" v-model="value" v-bind="field"
                        class="text-white text-xl w-full font-normal z-20 leading-loose bg-transparent outline-none pr-20"
                        :placeholder="placeholder"></textarea>
                </div>
                <IconInputInvalid class="absolute right-0 top-0 transform translate-y-2/3 mr-16"
                    v-if="!meta.valid && meta.touched" />
                <IconInputValid class="absolute right-0 top-0 bottom-0 transform translate-y-2/3 mr-16"
                    v-if="meta.valid && meta.touched" />
                <label :for="name"
