<template>
  <div class="flex flex-col gap-2">
    <Field :name="name" :id="name" :rules="rules" v-model="value" v-slot="{ field, meta }">
      <div
        class="px-4 py-2 bg-neutral-900 rounded border border-gray-500 relative"
        :class="
      ...
      >
        ...
        <IconInputInvalid
          class="absolute right-0 top-0 transform translate-y-2/3 mr-16 hidden lg:block"
          v-if="!meta.valid && meta.touched"
        />
        <IconInputValid
          class="absolute right-0 top-0 bottom-0 transform translate-y-2/3 mr-16 hidden lg:block"
          v-if="meta.valid && meta.touched"
        />
        <label
          :for="name"
      ...
      <IconInputValid
        class="absolute right-0 mr-2 mt-10 lg:hidden"
        v-if="meta.valid && meta.touched"
      />
      <IconInputInvalid
        class="absolute right-0 mr-2 mt-10 lg:hidden"
